...
15. process_bank_search() - Функция для поиска в списке словарей операций по заданной строке.
16. process_bank_operations() - Функция для подсчета количества банковских операций определенного типа.
17. main() - Сборка всех функций проекта в приложение.
